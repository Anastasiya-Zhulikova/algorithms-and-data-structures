...
### [Решение данной задачи](./J_chislo.py)
...
### [Решение данной задачи](./K_anti_quick_sort.py)
...
### [Решение данной задачи](./L_taxi.py)
...
## Yandex_A. Количество инверсий.

Дан массив $a$ из $n$ целых чисел. Необходимо вычислить количество инверсий в этом массиве.

### Входные данные
В первой строке - целое число $n$ - количество элементов массива. Во второй записаны $n$ чисел через пробел.
...
### [Решение данной задачи](./Yandex_A.py)
...
## Yandex_B. Количество полуинверсий.
...
### [Решение данной задачи](./Yandex_B.py)
...
### [Решение данной задачи](./Yandex_C.py)
